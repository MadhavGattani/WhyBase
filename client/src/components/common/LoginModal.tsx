// client/src/components/common/LoginModal.tsx
"use client";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative w-full max-w-md bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-2xl border border-white/10 overflow-hidden animate-slideUp">
        ...
        <div className="relative p-8">
          ...
          <h2 className="text-2xl font-bold text-white text-center mb-2">Welcome to Loominal</h2>
          <p className="text-white/60 text-center mb-8">Sign in to unlock powerful AI-driven writing tools</p>
          ...
          <div className="mt-8 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-white/70">Save and manage your prompts and templates</div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-3 h-3 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="text-sm text-white/70">Access your history across devices</div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-3 h-3 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="text-sm text-white/70">Upload and manage files securely</div>
            </div>
          </div>
